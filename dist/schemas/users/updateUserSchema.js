...
exports. default = _joi2.default.object({
    name: _joi2.default.string().min(3).max(20).regex(/^[^\d]+$/i),
    surname: _joi2.default.string().min(3).max(50).regex(/^[^\d]+$/i),
    tel: _joi2.default.string(),
    email: _joi2.default.string().min(9).max(150).email(),
    password: _joi2.default.string().min(6).max(50)
})
